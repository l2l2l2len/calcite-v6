...
const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted, onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-navy overflow-y-auto no-scrollbar">
        ...
        <div className="relative px-6 pt-12 pb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="px-8 py-4 rounded-xl font-semibold text-white/80 border border-white/20 hover:bg-white/5 transition-all"
            >
              Learn More
            </button>
          </div>
      ...
      <div ref={featuresRef} className="px-6 py-16 bg-surface-secondary dark:bg-navy-light/10">
        <div className="mb-10">
      ...
      <div className="px-6 py-8 bg-navy text-white">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={scrollToFeatures} className="text-sm text-white/70 hover:text-white transition-colors">
                  Features
                </button>
              </li>
              <li>
                <button onClick={onGetStarted} className="text-sm text-white/70 hover:text-white transition-colors">
                  Calculators
                </button>
              </li>
              <li>
        ...
        <div className="flex items-center justify-between pt-6 border-t border-white/10">
          ...
          <p className="text-white/40 text-xs">v6.0.0</p>
        </div>
